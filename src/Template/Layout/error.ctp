...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/themes/robot-svg/css/page.css">
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:700,300' rel='stylesheet' type='text/css'>

    <script src="/themes/robot-svg/js/tweenmax.min.js" type="text/javascript"></script>
    <script src="/themes/robot-svg/js/brokebot.js" type="text/javascript"></script>
    <script src="/themes/robot-svg/js/snap.svg-min.js" type="text/javascript"></script>
    <script>
        var isHeadless = true;
    </script>
</head>
        ...
        <div class="robotpage-bottom-half">
            ...
            <div>
                ...
                <div class="robot-buttons">
                    <a class="robot-buttons" href="/">Home</a>
                    <a class="robot-buttons" href="/about">About</a>
                    <a class="robot-buttons" href="/contact">Contact</a>
                </div>
            </div>
            <div class="clear"></div>
        </div>
